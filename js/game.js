class Game {
    ...
    //  invisibleGround.addImage("ground", ground_img);
    
      invisibleGround2 = createSprite(14200,displayHeight-40,1000,10);
  //    invisibleGround2.addImage("ground", ground2_img); 
//      invisibleGround2.scale=0.5
 ...
 //       player.update();
      ...
      if (keyDown(DOWN_ARROW) && player.index !== null) {
        player.distance1 += 10
        console.log("X,y" + x,y)
        console.log("players" +  players[index - 1].x, players[index - 1].y)
        player.update();
      }
